      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div>
            ...
            <h2 className="font-serif text-3xl lg:text-5xl text-navy leading-tight">Most Loved Picks</h2>
          </div>
          <Link to="/trending" className="hidden sm:inline-flex btn-outline text-xs px-6 py-2.5">
            View All
          </Link>
        </motion.div>
        ...
        >
          <Link to="/trending" className="btn-outline text-xs">
            View All Trending
          </Link>
        </motion.div>
      </div>
